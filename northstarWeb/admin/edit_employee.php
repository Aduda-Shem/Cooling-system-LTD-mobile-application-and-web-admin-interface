...
if(isset($_POST["btn_update"]))
{
 ...
 if (move_uploaded_file($_FILES['image']['tmp_name'], $target)) {
  @unlink("uploadImage/Profile/".$_POST['old_image']);
      ...
      $q1="UPDATE `employee` SET `fname`='$fname',`lname`='$lname',`email`='$email',`address`='$address',`gender`='$gender',`contact`='$contact',`dob`='$dob' ,`image`='$image' WHERE `id`='".$_GET['id']."'";
   ;
...
<?php
$que="select * from employee where id='".$_GET["id"]."'";
