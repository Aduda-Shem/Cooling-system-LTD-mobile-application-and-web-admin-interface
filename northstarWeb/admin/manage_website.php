                            ...
                            <form class="form-horizontal" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" value="<?php echo $short_title; ?>" name="short_title"
                                                class="form-control">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-9">
                                            <textarea class="textarea_editor form-control" name="footer" rows="5"
                                                placeholder="Enter text ..."
                                                style="height:300px;"><?php echo $footer; ?></textarea>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" value="<?php echo $currency_code; ?>"
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" value="<?php echo $currency_symbol; ?>"
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-9">
                                            <image class="profile-img" src="uploadImage/Logo/<?= $website_logo ?>"
                                                style="height:35%;width:25%;">
                                                <input type="hidden" value="<?= $website_logo ?>"
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-9">
                                            <image class="profile-img" src="uploadImage/Logo/<?= $login_logo ?>"
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-9">
                                            <image class="profile-img"
                                                src="uploadImage/Logo/<?= $background_login_image ?>"
                                                style="height:35%;width:35%;">
                                                <input type="hidden" value="<?= $background_login_image ?>"
                                                    name="old_back_login_image">
                                ...
                                <button type="submit" name="btn_web"
