...
<div class="page-wrapper">
    ...
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h3 class="text-primary"> View Employees</h3>
        </div>
        ...
        <div class="table-responsive m-t-40">
            ...
            ?>
                  ...
                  ?>
                            ...
                            <a href="activate_employee.php?id=<?= $row['id']; ?>"><button type="button"
                                    class="btn btn-xs btn-primary"><i class="fa fa-exchange"></i> Approve</button></a>
                            <a href="activate_employee1.php?id=<?= $row['id']; ?>"><button type="button"
